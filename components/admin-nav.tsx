...
export function AdminNav() {
  const items = [{ href: "/admin", label: "대시보드", icon: LayoutDashboard }, { href: "/admin/courses", label: "수업 관리", icon: BookOpen }, { href: "/admin/messages", label: "문의 관리", icon: MessageSquare }];
