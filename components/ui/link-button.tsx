...
export function LinkButton({ className, variant = "primary", size = "md", ...props }: Props) {
  return <Link className={cn(
    "focus-ring inline-flex items-center justify-center rounded-xl font-semibold transition",
